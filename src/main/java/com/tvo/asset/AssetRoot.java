...
public abstract class AssetRoot {
	 ...
	 * asset_type = 'segment' is the meta data for the video (possible, very similar to program)
	 * asset_type = 'series' is treated the same as a program
	 * Series->Program->Segment->ElementVideo
	 */
	
	// NA is not applicable and will be skipped.
	public enum AssetType { PROMO, SERIES, PROGRAM, VIDEO, ARTICLE, BLOG, GAME, CONTEST, NA }
    ...
    protected int saveRoot() throws SQLException {
        ...
        SimpleJdbcInsert jdbcInsert = new SimpleJdbcInsert(DbWebRepository.getDataSource()).withTableName("asset_root").usingGeneratedKeyColumns("asset_root_id");
